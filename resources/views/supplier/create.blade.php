                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group {{$errors->has('doc_no')?'has-error':''}}">
                                    ...
                                    {{Form::text('doc_no', null, ['class'=>'form-control','placeholder'=>'DOC/2018/XXX'])}}
                                    <span class="help-block">{{$errors->first('doc_no')?$errors->first('doc_no'):''}}</span>
                                </div>

                                <div class="form-group {{$errors->has('reciept_no')?'has-error':''}}">
                                    <label for="reciept_no">Payment Receipt Number</label>
                                    {{Form::text('reciept_no', null, ['class'=>'form-control','placeholder'=>'Payment Receipt Number'])}}
                                ...
                                <div class="form-group {{$errors->has('phone_1')?'has-error':''}}">
                                    ...
                                    {{Form::text('phone_1', null, ['class'=>'form-control','placeholder'=>'0114562411'])}}
                                ...
                                <div class="form-group {{$errors->has('fax_2')?'has-error':''}}">
                                    ...
                                    {{Form::text('fax_2', null, ['class'=>'form-control','placeholder'=>'0114561211'])}}
                            ...
                            <div class="col-md-6">
                                <div class="form-group {{$errors->has('business_reg_no')?'has-error':''}}">
                                    ...
                                    {{Form::text('business_reg_no', null, ['class'=>'form-control','placeholder'=>'PV00011'])}}
                                    <span class="help-block">{{$errors->first('business_reg_no')?$errors->first('business_reg_no'):''}}</span>
                                </div>

                                <div class="form-group {{$errors->has('business_reg_date')?'has-error':''}}">
                                    <label for="business_reg_date">Business Registration Date</label>
                                    {{Form::date('business_reg_date', null, ['class'=>'form-control','placeholder'=>'Business Registration Date'])}}
                                ...
                                <div class="form-group {{$errors->has('vat_no')?'has-error':''}}">
                                    ...
                                    {{Form::text('vat_no', null, ['class'=>'form-control','placeholder'=>'520000000'])}}
                                ...
                                <div class="form-group {{$errors->has('contact_person')?'has-error':''}}">
                                    ...
                                    {{Form::text('contact_person', null, ['class'=>'form-control','placeholder'=>''])}}
