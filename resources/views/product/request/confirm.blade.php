...
@section('header')
    <i class="fa fa-check-square-o"></i> Confirm Products Requests
@endsection
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <table class="table" id="tblProduct">
                                                            ...
                                                            <tbody>
                                                            {!! Form::open(['action' => 'ProductRequestController@approve','method'=>'POST']) !!}
                                                            @if($request->items)
                                            ...
                                            <div class="modal-footer">
                                                @if($request->confirmed_at || $request->last_issued_at || $request->completed_at)
                                                    <a data-toggle="modal" data-target="#modalApproved{{$request->id}}" class="btn btn-default btnOK">OK</a>
                                                @elseif($request->approved_at)
                                                    {!! Form::Submit('Confirm',['class'=>'btn btn-success','name'=>'confirm']) !!}
                                                    {!! Form::Submit('Deny',['class'=>'btn btn-danger','name'=>'deny_confirmation']) !!}
                                                @endif
