            ...
            <div class="box box-primary">
                ...
                {!! Form::model($user,['action' => ['UserController@update',$user->id],'method'=>'PATCH']) !!}
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-12">
                                <img src="{{asset($user->employee?$user->employee->img_url?url($user->employee->img_url):url('img/user.png'):'')}}" alt="" class="img-rounded img-thumbnail" id="imgUser">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group {{$errors->has('id')?'has-error':''}}">
                                    ...
                                    {!! Form::text('emp_id', $user->employee->emp_id,['class'=>'form-control form-control-sm','readonly']) !!}
